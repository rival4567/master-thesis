\begin{figure}
    ...
    \begin{tikzpicture}[
      ...
      \node[device] (PLC) {PLC};
      \node[device, below=2cm of PLC] (KR1410) {KR1410 Robot};
      ...
      \draw[connection] (PLC) -- (InspectionCamera) node[protocol, midway] {Ethernet};
