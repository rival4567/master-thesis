\begin{figure}[h]
    ...
    \begin{tikzpicture}[
        ...
        rect/.style={draw=purple, rectangle, rounded corners=8pt, align=center, inner sep=12pt},
        ...
        \node (plc) [gray, below=4.5cm of bending, inner sep=10pt] {PLC};
        \node (pandarobot) [cyan, above left=0.5cm and 1.5cm of plc] {Panda\\ Robot};
        ...
        \node (storage) [rect, below=3cm of camera3, text=purple] {Storage\\ Station};
        \node (camera2) [cyan, above left=of pandarobot] {Camera};
        \node (unloading) [rect, below=of plc, draw=gray, text=gray] {Unloading\\ Station};
