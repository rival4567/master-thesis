...
Two cameras are selected from \hyperref[acro:SensoPart]{SENSOPART}. One for the robot which is used to detect the sheet metal parts and the target mark; and the other for inspection jobs.
